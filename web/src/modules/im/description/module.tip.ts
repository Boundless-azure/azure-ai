...
export const moduleTip = {
  ...
  keywords: {
    cn: {
      ...
      重连: 'src/modules/im/services/im.socket.service.ts',
      无限重连: 'src/modules/im/constants/im.constants.ts',
    ...
    en: {
      ...
      reconnection: 'src/modules/im/services/im.socket.service.ts',
      infinite_reconnect: 'src/modules/im/constants/im.constants.ts',
