...
const translations = {
  en: {
    ...
    knowledge: {
      ...
      subtitle: 'Manage skill and lore books',
      create: 'New Book',
      all: 'All',
      typeSkill: 'Skill',
      typeLore: 'Lore',
      typeSkillDesc: 'How to operate the corresponding Hook',
      typeLoreDesc: 'Records ideas or directly entered knowledge',
      empty: 'No books yet',
      embedded: 'Embedded',
      chapters: 'chapters',
      edit: 'Edit',
      buildVector: 'Build Vector',
      reEmbed: 'Re-embed',
      delete: 'Delete',
      createTitle: 'Create Knowledge Book',
      type: 'Book Type',
      name: 'Book Name',
      ...
      toc: 'Contents',
      lmRequired: 'LM Required',
      noChapters: 'No chapters yet',
      selectChapter: 'Select a chapter on the left to start editing',
      ...
      markLmRequired: 'Mark as LM Required',
      lmRequiredHint: '(Always included for AI)',
    },
    solution: {
  ...
  cn: {
    ...
    knowledge: {
      ...
      typeSkill: '技能',
      typeLore: '学识',
      typeSkillDesc: '描述如何操作对应的 Hook 能力',
      typeLoreDesc: '记录具体思路或直接录入的书本知识',
      empty: '暂无书本',
      embedded: '已向量化',
      chapters: '章节',
      edit: '编辑',
      ...
      type: '书本类型',
      name: '书本名称',
      namePlaceholder: '输入书本名称...',
      description: '描述',
      descHint: '（选填）',
      descPlaceholder: '简要描述这本书的内容...',
      notEmbedded: '未向量化',
      addChapter: '新增章节',
      toc: '目录',
      lmRequired: 'LM 必读',
      noChapters: '暂无章节',
      selectChapter: '选择左侧章节开始编辑',
      ...
      markLmRequired: '标记为 LM 必读',
      lmRequiredHint: '（所有章节必读）',
    },
  },
};
