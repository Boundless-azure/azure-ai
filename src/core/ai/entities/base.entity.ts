 ...
 * @keyword-cn 基础实体, 主键标识, 审计字段
 * @keyword-en base-entity, primary-id, audit-fields
 */
export abstract class BaseAuditedEntity {
  ...
  @Column({ name: 'created_user', type: 'varchar', length: 36, nullable: true })
  createdUser!: string;

  @Column({ name: 'update_user', type: 'varchar', length: 36, nullable: true })
  updateUser!: string;
   ...
   * @keyword-cn 主键生成, UUID, 插入前
   * @keyword-en id-generation, uuid-v7, before-insert
   */
  @BeforeInsert()
